...
#define accSCL_Pin GPIO_PIN_8
#define accSCL_GPIO_Port GPIOB
#define accSDA_Pin GPIO_PIN_9
#define accSDA_GPIO_Port GPIOB

/* USER CODE BEGIN Private defines */
#define UART_RX_BUFFER_SIZE 1024  // tamanho do buffer (ajuste conforme necessário)
#define SAFE_MAX_DATA_BUFFER_SIZE 50 //tamanho para iniciar salvamento SD
